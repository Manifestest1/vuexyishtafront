    ...
    >
      ...
      >
        ...
        >
          ...
          <MenuItem href={`/${locale}/dashboards/facescape`}>{dictionary['navigation'].facescape}</MenuItem>
          <MenuItem href={`/${locale}/dashboards/narratone`}>{dictionary['navigation'].narratone}</MenuItem>
