          ...
          <Card className='flex flex-col sm:is-[450px]'>
            <CardContent className='sm:!p-12'>
              ...
              <form noValidate autoComplete='off' onSubmit={handleSubmit} className='flex flex-col gap-6'>
                <CustomTextField autoFocus fullWidth label='Username' placeholder='Enter your username' onChange={(e) => setName(e.target.value)}/>
                {error && !name && <span className='input-error'>Please enter valid name.</span>}
                <CustomTextField fullWidth label='Email' placeholder='Enter your email'  onChange={(e) => setEmail(e.target.value)}/>
